...
[^05-importation-transformation-4]: Voyez `?tidyselect::select_helpers` pour une panoplie de fonctions supplémentaires qui permettent une sélection "intelligente" des variables utilisables avec `select()`.
...
if (exists("assignment"))
  assignment("A05Ia_transformation", part = NULL,
    ...
    course.urls = c(
      'S-BIOG-006' = "https://classroom.github.com/a/m6qqsVX0"),
    course.starts = c(
