...
Ce module est élaboré sur les notions de probabilité, de loi de distribution statistique et de test d'hypothèse abordées dans les deux module précédents \@ref(probacorr) et \@ref(districhi2). La matière de ces deux modules doit donc être maîtrisée avant d'aller plus avant ici.
