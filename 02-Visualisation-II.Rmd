...
if (exists("assignment"))
  assignment("A02Ia_distributions", part = NULL,
    ...
    course.starts = c(
      'S-BIOG-006' = !"{W[7]+1} 10:00:00"),
    course.ends = c(
      'S-BIOG-006' = !"{W[8]+1} 23:59:59"),
    term = "Q1", level = 3,
...
```{r assign_A02Ga_analysis, echo=FALSE, results='asis'}
if (exists("assignment2"))
  assignment2("A02Ga_analysis", part = NULL,
    ...
    course.starts = c(
      'S-BIOG-006' = !"{W[5]+1} 09:00:00"),
    course.ends = c(
      'S-BIOG-006' = !"{W[15]+2} 23:59:59"),
    term = "Q1", level = 4, n = 4,
    toc = "Analyse de données (par groupe de 4)")
```
