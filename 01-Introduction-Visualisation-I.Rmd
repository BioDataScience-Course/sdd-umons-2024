...
Passons maintenant à la pratique. Vous allez réaliser votre premier projet.
...
```{=html}
<!--G.E 
1° le lien dans le cours github classroom, 
2°création de votre projet sur github explication breve sur github
3° Copie en local de votre projet dans SV Box, il faut donc connaitre le clone
4°
-->
```
### Projet RStudio
