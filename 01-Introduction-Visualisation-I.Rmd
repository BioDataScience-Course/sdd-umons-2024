...
Un chatbot vous est mis à votre disposition dans le cadre de ce cours.
...
````{=html}
<!--TODO Ajouter des infos sur comment rechercher de l'aide

1. help à la console 

En lisant **la page d'aide de la fonction**. Pour cela, utilisez l'opérateur `?` suivi du nom de la fonction. Dans RStudio, la page d'aide apparaît dans l'onglet **Aide** ou \*Help\*\* (selon que l'interface de RStudio soit en français ou en anglais, voir copie d'écran ci-dessous).
...
3. Help dans la fenêtre du bas, puis expliquer 
...
Il y a plusieurs solutions afin de trouver de l'aide sur R pour nos cours.
