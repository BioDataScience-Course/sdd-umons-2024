...
`r learnr("A10La_anova", title = "ANOVA et tests post-hoc", toc = "Analyse de variance et tests post-hoc")`
...
if (exists("assignment"))
  assignment("A10Ia_acidification_effect", part = NULL,
    ...
    course.urls = c(
      'S-BIOG-027' = "https://classroom.github.com/a/Jy9gGqx0"),
    course.starts = c(
